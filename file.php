...
<body>
    <form method="post" enctype="multipart/form-data">
        <!-- Mẫu form cho việc tải lên tệp tin -->
    ...
    if(isset($_POST['upload'])){
        ...
        if(isset($_FILES['fileToUpload'])){
            // Kiểm tra xem mảng $_FILES có tồn tại

            $file = $_FILES['fileToUpload'];
            $file_path = $file['tmp_name'];
            // Lấy thông tin về tệp tin tải lên và đường dẫn tạm thời

            if(file_exists($file_path)){
                // Kiểm tra xem tệp tin tải lên có tồn tại

                $file_content = file_get_contents($file_path);
                // Đọc nội dung của tệp tin tải lên
                ...
                // Thông báo nếu không thể đọc tệp tin tải lên
            }
        }
    }
    ?>
